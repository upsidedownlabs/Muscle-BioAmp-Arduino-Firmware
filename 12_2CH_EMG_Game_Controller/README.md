...
<div style="margin-bottom: 20px;">
  <h4 style="font-size: 25px;">Step 1: Stack Muscle BioAmp Shield on Arduino Uno</h4>
...
<div style="margin-bottom: 20px;">
  <h4 style="font-size: 25px;">Step 2: Configure BioAmp EXG Pill for EMG/ECG (Optional)</h4>
...
<div style="margin-bottom: 20px;">
  <h4 style="font-size: 25px;">Step 3: Connecting BioAmp EXG Pill</h4>
...
<div style="margin-bottom: 20px;">
  <h4 style="font-size: 25px;">Step 4: Connecting Electrode Cables</h4>
...
<div style="margin-bottom: 20px;">
  <h4 style="font-size: 25px;">Step 5: Skin Preparation</h4>
...
<div style="margin-bottom: 20px;">
  <h4 style="font-size: 25px;">Step 6: Electrode Placements</h4>
